...
class infoContainer extends Component {
    ...
    render() {
        ...
        <div id='available-cash' style={{ borderRadius: '50%', border: '10px solid red', height: '150px', width: '150px', display: 'inline-block', margin: '10px' }}>Annual Return: ${userStore.user.length}</div>
            <br/>
            <Link to={'/market'}>
