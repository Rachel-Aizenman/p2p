            ...
            <ul className="responsive_grid">
              ...
              <li>
                <div className="team_member">
                  <div className="info">
                    <img
                      src="https://www.clipartkey.com/mpngs/m/193-1936422_happy-employee-python-3-complete-masterclass-make-your.png"
                      alt=""
                    />
              ...
              <li>
                <div className="team_member">
                  <div className="info">
                    <img
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQU-5_JoETRAYQvtEwWPhkQWNSGLYRXRIQIek_C0xdpHFQGLs1H&s"
                      alt=""
                    />
                    <h5>Noam Lior</h5>
                    <h6>Director of Chemical Weaponry</h6>
